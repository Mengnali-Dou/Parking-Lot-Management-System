...
namespace _2022_4C.src
{
    ...
    /// 自动生成车辆进出场记录
    /// </summary>
    public class GeneratleLOEENum
    {
        public static string num()
        {
            string mantissa = null;
            string select = $"select LOEENum from LOEnterExit where EnterTime like '{DateTime.Now.ToShortDateString().ToString()}%'";
        ...
        public static string LOEENum(string Park)
        {
            string mantissa = num();
            ...
            string LOEENum = "LOEE" + y + m + d + Park + mantissa;
