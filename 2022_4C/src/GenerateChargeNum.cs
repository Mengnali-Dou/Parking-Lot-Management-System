...
namespace _2022_4C.src
{
    ...
    /// 生成收费编号
    /// </summary>
    public class GenerateChargeNum
    {
        public static string num()
        {
            string mantissa = null;
            string select = $"select ChargeNum from FIVehicleCharge where ChargeTime like '{DateTime.Now.ToShortDateString().ToString()}%'";
        ...
        public static string ChargeNum(string ParkNum)
        {
            ...
            string mantissa = num();
            string EnterNum = "CSF" + y + m + d + ParkNum + mantissa;
