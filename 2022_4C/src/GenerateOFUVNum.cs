...
{
    public class GenerateOFUVNum
    {
        public static string num()
        {
            string mantissa = null;
            string select = $"select OFUVNum from OFUnlicensedVehicle where EnterTime like '{DateTime.Now.ToShortDateString().ToString()}'";
        ...
        public static string OFUVNum(string ParkNum)
        {
            string mantissa = num();
            ...
            string OFUVNum = "WDD" + y + m + d + ParkNum + mantissa;
