...
namespace _2022_4C.src
{
    ...
    /// 生成车辆出场表
    /// </summary>
    public class GenerateExitNum
    {
        public static string num()
        {
            string mantissa = null;
            string select = $"select ExitNum from EEExitArena where ExitTime like '{DateTime.Now.ToShortDateString().ToString()}'";
        ...
        public static string ExitNum(string ParkNum)
        {
