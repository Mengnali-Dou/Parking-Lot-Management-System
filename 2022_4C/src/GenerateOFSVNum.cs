...
namespace _2022_4C.src
{
    ...
    /// 自动生成特殊车辆订单
    /// </summary>
    public class GenerateOFSVNum
    {
        public static string num()
        {
            string mantissa = null;
            string select = $"select OFSVNum from OFSpecialVehicle where EnterTime like '{DateTime.Now.ToShortDateString().ToString()}'";
        ...
        public static string OFSVNum(string ParkNum)
        {
            string mantissa = num();
            ...
            string OFTVNum = "TDD" + y + m + d + ParkNum + mantissa;
