...
namespace _2022_4C.src
{
    ...
    /// 自动生成车辆进场编号
    /// </summary>
    public class GeneratelEnterNum
    {
        public static string num()
        {
            string mantissa = null;
            string select = $"select EnterNum from EEEnterArena where EnterTime like '{DateTime.Now.ToShortDateString().ToString()}'";
        ...
        public static string EnterNum(string ParkNum)
        {
            ...
            string mantissa = num();
            string EnterNum = "EN" + y + m + d + ParkNum + mantissa;
