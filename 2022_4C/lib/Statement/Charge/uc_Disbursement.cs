...
{
    public partial class uc_Disbursement : UserControl
    {
        public uc_Disbursement()
        {
            InitializeComponent();
        }
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                string select = $"select * from FIDisbursement where DisNum = '{num}'";
                ...
                {
                    string sel = $"select DisComment from FIDisbursement where DisNum = '{num}'";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string update = $"update FIDisbursement set DisComment = '{comment}' where DisNum = '{num}'";
