...
{
    public partial class uc_sonFixedVehicle : UserControl
    {
        public uc_sonFixedVehicle()
        {
            InitializeComponent();
        }
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                string select = $"select * from OFFixedVehicle where OFFVNum = '{num}'";
                ...
                {
                    string sel = $"select OFFVComment from OFTemporaryVehicle where OFFVNum = '{num}'";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string update = $"update OFFixedVehicle set OFFVComment = '{comment}' where OFFVNum = '{num}'";
