...
{
    public partial class uc_sonSpecialVehicle : UserControl
    {
        public uc_sonSpecialVehicle()
        {
            InitializeComponent();
        }
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                string select = $"select * from OFSpecialVehicle where OFSVNum = '{num}'";
                ...
                {
                    string sel = $"select OFSVComment from OFSpecialVehicle where OFSVNum = '{num}'";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string update = $"update OFSpecialVehicle set OFSVComment = '{comment}' where OFSVNum = '{num}'";
